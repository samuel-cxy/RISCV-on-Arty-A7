...
REM
REM Generated by Vivado on Sat Jan 17 17:14:18 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_regress_day6_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_regress_day6_vlog.prj -log xvlog.log
